...
declare zeroext i8 @_Z20rsGetElementAt_uchar13rs_allocationjj([1 x i32], i32, i32)
...
declare void @_Z20rsSetElementAt_uchar13rs_allocationhjj([1 x i32], i8 zeroext, i32, i32)
